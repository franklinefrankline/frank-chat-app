...
def run_tests():
    print("==================================================")
    print("RUNNING DEPENDENCY-FREE QENVO TEST SUITE")
    print("==================================================")
    ...
    try:
        ...
        test_group = models.Group(
            ...
            description="Testing QENVO group architecture",
        ...
        doc = models.Document(
            ...
            group_id=test_group.id,
            original_filename="QENVO_Architecture.pdf",
        ...
        doc_msg = models.Message(
            ...
            group_id=test_group.id,
            content="Shared a file: QENVO_Architecture.pdf",
        ...
        new_msg_in = schemas.MessageCreate(
            ...
            content="Testing accurate timestamps in QENVO",
            message_type="text"
        )
        ...
        edit_in = schemas.MessageUpdate(content="Testing accurate timestamps in QENVO (Edited)")
        edited_msg = messages_module.edit_message(created_msg.id, edit_in, current_user=test_user, db=db)
        assert edited_msg.content == "Testing accurate timestamps in QENVO (Edited)"
