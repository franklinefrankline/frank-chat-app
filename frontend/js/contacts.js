            ...
            users.forEach(user => {
                ...
                card.innerHTML = `
                    ...
                    <div class="conversation-details">
                        ...
                        <div class="conversation-snippet">@${messagesModule.escapeHTML(user.username)} &bull; ${messagesModule.escapeHTML((user.bio || 'QENVO User').replace(/ChatApp/gi, 'QENVO'))}</div>
                    </div>
                `;
